export const profile = {
  name: "Cristopher Arias",
  handle: "@qriqs",
  username: "qriqs",
  avatar: "https://avatars.githubusercontent.com/u/65689762?v=4",
  role: "DevOps & Cloud Engineer",
  quote: '"Fear is the mind-killer" — Frank Herbert',
  status: "Automate everything · Deploy anywhere",
  location: "Lima, Peru 🇵🇪",
  bio: [
    "DevOps & Cloud Engineer · Building scalable infrastructure.",
    "Linux · Docker · Kubernetes · Terraform · AWS · Ansible.",
    "CI/CD · Prometheus · Bash · Python · Go · Web Systems.",
    "Partner at @openhublabs & @sinfloros.",
  ],
  skills: [
    "Kubernetes",
    "Docker",
  ...
  stats: [
    ...
    { label: "Stars", value: "19+" },
    { label: "Status", value: "Pro" },
  ],
  orgs: [
    { name: "openhublabs", label: "OpenHub Labs", avatar: "https://avatars.githubusercontent.com/u/294030715?s=64&v=4" },
    { name: "sinfloros", label: "Sin Floros", avatar: "https://avatars.githubusercontent.com/u/264530451?s=64&v=4" },
  ],
};
...
export const links = [
  {
    ...
    tags: ["Startup Platform", "Engineering", "Production"],
  },
  {
    id: "openhub-app",
    title: "openhublabs / openhub-app",
    ...
    tags: ["Kotlin", "OpenHub Labs", "Mobile"],
  },
  {
    id: "sinfloros-app",
    title: "sinfloros / sinfloros-app",
    ...
    tags: ["TypeScript", "Sin Floros", "Web Platform"],
  },
  {
    id: "english-keynotes",
    title: "qriqs / english-keynotes",
